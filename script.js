//below is the used splashes non-test
const splashes = ["§1C§2o§3l§4o§5r§6m§7a§8t§9i§ac", "§kFUNKY LOL", "Home-Made!", "Déjà vu!", "Vote for net neutrality!", "90% bug free!", "Cloud computing!", "One of a kind!", "As seen on TV!","Awesome!","One of a kind!","Indev!","Check it out!", ".Dev!", "Turing-complete!", "Open source!"];

//below is full list of minecraft splashes
...
//below is list of splashes for testing
//const splashes = ["§1C§2o§3l§4o§5r§6m§7a§8t§9i§ac", "§kFUNKY LOL"]
...
projects = [["AutoMC", "https://github.com/Apex1177/AutoMC"], ["LiveWallpaper", "https://github.com/Apex1177/LiveWallpaper"]]
